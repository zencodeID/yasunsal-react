...
import appsunsal from '../images/sunsal.png'
      ...
      <div class="container mx-auto flex flex-col items-center px-5 py-24 md:flex-row">
        ...
        >
          ...
          <p class="mb-8 leading-relaxed">
            Dengan sunsal mobile , wali santri dapat memantau perkembangan
            akademik santri hanya dengan satu genggaman.
          </p>
          ...
          <div class="flex md:flex-col lg:flex-row">
            <a
              href="https://play.google.com/store/apps/details?id=com.sunsalmobilesiswa"
              class="inline-flex items-center rounded-lg bg-dark py-3 px-5 text-white hover:bg-kedua hover:text-gray-100 focus:outline-none"
            >
              <svg
            ...
            <a
              href="https://apps.apple.com/id/app/sunsal-mobile/id1574080271?l=id"
              class="ml-4 mt-0 inline-flex items-center rounded-lg bg-dark py-3 px-5 text-white hover:bg-kedua hover:text-gray-100 focus:outline-none md:ml-0 md:mt-4 lg:ml-4 lg:mt-0"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="currentColor"
              ...
              <span class="ml-4 flex flex-col items-start leading-none">
                <span class="mb-1 text-xs text-white">Download it on</span>
                <span class="title-font font-medium">App Store</span>
              </span>
            </a>
          </div>
        </div>
        <div class="w-5/6 md:w-1/2 lg:w-full lg:max-w-lg" data-tilt>
          <img
