...
function Footer() {
  return (
    <footer class="body-font bg-dark">
      <div class="container mx-auto flex flex-col items-center px-5 py-8 sm:flex-row">
        <a class="title-font flex items-center justify-center font-medium text-white md:justify-start">
          <img src={sunsal} alt="" class="w-26" width="65" height="28" />
          <span class="ml-3 text-xl uppercase">Yayasan Sunniyah Salafiyah</span>
        </a>
        <p class="mt-4 text-sm text-white sm:ml-4 sm:mt-0 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:pl-4">
          © 2022 yayasan sunniyah salafiyah —
          <a
